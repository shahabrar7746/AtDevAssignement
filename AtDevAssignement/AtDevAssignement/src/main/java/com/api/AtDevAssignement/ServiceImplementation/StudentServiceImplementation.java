package com.api.AtDevAssignement.ServiceImplementation;
...
import com.api.AtDevAssignement.Repository.StudentRepo;
...
return ResponseEntity.ok(data);
    ...
    @Override
    public ResponseEntity<StudentDTO> update(StudentDTO dto, int id) throws InvalidStudentId {
        Optional<Student> optionalObj = repo.findById(id);
        if(!optionalObj.isPresent()){
            throw new InvalidStudentId("Invalid Student id");
        }
    ...
    @Override
    public ResponseEntity<String> delete(int id) throws InvalidStudentId {
        Optional<Student> optionalObj = repo.findById(id);
        if(!optionalObj.isPresent()){
            throw new InvalidStudentId("Invalid Student id");
        }
